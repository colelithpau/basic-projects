...
LYRICS = [
    (16.2, "I never meant to"),
    (16.5, "cause you any sorrow"),
    (23.3, "I never meant to"),
    (23.5, "cause you any pain"),
    (32.2, "I only wanted"),
    (32.5, "one time to see you laughing"),
    (37.7, "I only want to see you laughing"),
    (41.2, "In the purple rain"),
    (45.5, "Purple rain, purple rain"),
    (54.5, "Purple rain, purple rain"),
    (62.6, "Purple rain, purple rain"),
    (74.0, "I only want to see you bathing in the purple rain"),
]
...
RISE_SPEED = 100          # pixels per second every box moves upward
